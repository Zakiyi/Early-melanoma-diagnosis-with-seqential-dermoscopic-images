...
if __name__ == "__main__":
    ...
    training_result_dirs = '/home/zyi/My_disk/medical_AI/cnn-diff-hc-san/tkd_distill_klv/round_0'
    cfg['model'] = 'cnn-diff-hc-san'
    seq_length = [4]
    ...
    legends = []
    res_list = glob(os.path.join(training_result_dirs, 'd*'))
    res_list = sorted(res_list, key=lambda x: np.float(x.split('_')[-2]))
    for dir in res_list:
