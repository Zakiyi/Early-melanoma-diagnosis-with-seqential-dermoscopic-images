...
if plot_res:
    ...
    colors = ["g", "g", "r", "g", "r", "r", "g", "r", "r", "r", "r", "g"]
    # Set your custom color palette
    # customPalette = sns.set_palette(sns.color_palette(colors))
    sns.stripplot(y="diagnose_date", x="image_id", hue='evaluator', dodge=True,
                  data=test_csv, alpha=1.0, zorder=0, edgecolor='black', size=4, marker='o')
    ...
    for id in image_id:
        b.text(id-1, image_num[id-1]+0.2, diagnose_num[id-1], color='black', ha="center", fontsize=6.5)
    ...
    plt.tight_layout()
    plt.savefig('/media/zyi/080c2d74-aa6d-4851-acdc-c9588854e17c/medical_AI/CrossValidation_test/human_results/diagnosestar.png', dpi=600)
    plt.show()
