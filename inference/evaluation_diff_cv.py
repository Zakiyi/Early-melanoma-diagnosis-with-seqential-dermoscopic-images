...
def evaluation(cfg, model, data_split_file):
    ...
    dataset = Skin_Dataset(cfg['data']['root'], data_split_file[0]['test'], seq_length=cfg['data']['seq_length'],
...
def cross_fold_validation(cfg, result_dir, best_model=True, show_roc=True):
    ...
    with open(os.path.join(result_dir, model_file.split('.')[0] + '_final_test.json'), 'w') as f:
...
if __name__ == "__main__":
    ...
    training_result_dirs = '/media/zyi/080c2d74-aa6d-4851-acdc-c9588854e17c/medical_AI/CrossValidation_test/baseline/round_0'
