...
def cross_fold_validation(cfg, result_dir, best_model=True, show_roc=True):
    ...
    with open(os.path.join(run_exp_dir, 'data_setting', 'data_split_replaced.pkl'), 'rb') as f:
...
if __name__ == "__main__":
    ...
    cfg['data']['root'] = '/home/zyi/MedicalAI/HR_Serial_Skin_data_320_replaced'
    training_result_dirs = '/media/zyi/080c2d74-aa6d-4851-acdc-c9588854e17c/medical_AI/run_exp/cnn-diff-hc_MIC/orginal_random_seq/without_alignment_data'
