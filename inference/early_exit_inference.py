...
if __name__ == "__main__":
    ...
    seq_length = [4]
    # for training_result_dir in glob(os.path.join(training_result_dirs, 'b*')):
    ...
    # dst = ['dst_bce_0.1_0.9', 'dst_bce_0.2_0.8', 'dst_bce_0.3_0.7', 'dst_bce_0.4_0.6', 'dst_bce_0.5_0.5']
    ...
    #
    # legends = [r'$\alpha=0.1$', r'$\alpha=0.2$', r'$\alpha=0.3$', r'$\alpha=0.4$', r'$\alpha=0.5$']
    # plt.legend(legends)
    # plt.ylim([66, 74])
    # plt.ylabel('AUC')
    # plt.xticks([0, 1, 2, 3], ['time_0', 'time_1', 'time_2', 'time_3'])
