...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, att_position, att_dim, GSoP_mode=1, num_classes=1000):
        self.inplanes = 64
...
if __name__ == '__main__':
    att = '1'
    att_position = [['0'] * 2 + [att], ['0'] * 3 + [att], ['0'] * 5 + [att], ['0'] * 2 + [att]]
    model = resnet50(pretrained=True, att_position=att_position, att_dim=128)
    print(model)